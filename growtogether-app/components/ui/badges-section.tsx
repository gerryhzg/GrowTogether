  ...
  return (
    <div className="lg:col-span-2 relative overflow-hidden">
      ...
      <div className="rounded-[2rem] bg-white/80 p-6 shadow-sm">
        <p className="text-sm uppercase tracking-[0.25em] text-secondary">{isNeonQuest ? "Flex Badges" : isWoodland ? "Growth Markers" : isFarm ? "Prize Ribbons" : "Achievement Badges"}</p>
